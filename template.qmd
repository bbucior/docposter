...
format:
  docposter-html:
    ...
    export-pdf: true  # TODO: not yet implemented
...
source("chrome_pdf.R")
chrome_pdf(html_path = "template.html")
```
...
1. (NOT YET UPDATED) `devtools::install_github("bbucior/drposter", dep=FALSE)` (or `install_local` on a downloaded copy) to install/update the package
