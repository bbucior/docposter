...
author:
  #["<span class=\"presenter\">Ben Bucior<sup>1</sup></span>, &lt;Your name here&gt;<sup>2</sup><ol class=\"affiliations\"><li>Northwestern University, Evanston, IL, USA</li><li>Earth</li></ol>"]
  - name: Ben Bucior
    affiliations:
...
<div class="fullwidth">See also the [source code](https://github.com/bbucior/drposter/tree/master/template.qmd) and [compiled pdf](https://github.com/bbucior/drposter/tree/master/Resources/example_poster.pdf) for this poster on GitHub.</div>
